    ...
    foreach c of local catlist {
        preserve
            ...
            bunch_count zj bincounts, ///
                bpoint(-1) binwidth(1) degree(`q') max_it(500) ///
...
texdoc init "/Users/yxy/UChi/Summer2025/Procurement/res/tab/Poly_Table.tex", replace force

texdoc write \begin{table}[htbp]\centering
texdoc write \caption{Polynomial Regression Specification Checks -- Choice of the Order of the Polynomial}
...
local col = 1
foreach q of local pol {
    texdoc write \multicolumn{4}{l}{Order of the Polynomial: `q'$^{th}$} \\
